...
*These additions are implemented in the `jzod` crate (merged to `main`). They are NOT yet ratified spec — they are captured here so collaborators and implementors can evaluate them before they stabilize.*
